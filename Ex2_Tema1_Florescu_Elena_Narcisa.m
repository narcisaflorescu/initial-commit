...
s = sawtooth (pi*t,1/2); %generam un semnal triunghiular de perioada t
...
s = sawtooth (pi*t2,1/2); %generam un semnal triunghiular de perioada t
% setam 1/2 pentru a genera un semnal triunghiular standard
s = s*1.5 -0.5;
subplot(3,1,2), plot(t2,s)
axis([0 5 -2.5 2.5])
title('Semnal triunghiular periodic') %titlul graficului
