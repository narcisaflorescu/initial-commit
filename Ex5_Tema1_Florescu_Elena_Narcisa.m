...
s = A*sin(2*pi*F*t); %generam un semnal sinusoidal de perioada t
for i = 1:length(s) %pentru a avea semnal sinusoidal redresat dubla alternanta
    if s(i)<0
        s(i)=-s(i);
    end
end
...
axis([0 4 0 2])
title('Semnal sinusoidal redresat dubla alternanta') %titlul graficului
